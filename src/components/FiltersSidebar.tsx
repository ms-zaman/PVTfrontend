...
import { FilterOptions, SeverityLevel, BANGLADESH_DIVISIONS } from '@/types';
import { 
  Calendar, 
  MapPin, 
  Users, 
...
export default function FiltersSidebar({
  ...
  const handleMultiSelectChange = (
    field: keyof Pick<FilterOptions, 'politicalParties' | 'divisions' | 'districts' | 'severityLevels'>,
    value: string
  ) => {
    setLocalFilters(prev => {
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-medium text-gray-900 dark:text-gray-100">Date Range</h3>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-medium text-gray-900 dark:text-gray-100">Political Parties</h3>
            </div>
            <div className="space-y-2 max-h-40 overflow-y-auto">
              {availableParties.map(party => (
                <label key={party} className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={localFilters.politicalParties.includes(party)}
                    onChange={() => handleMultiSelectChange('politicalParties', party)}
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-medium text-gray-900 dark:text-gray-100">Divisions</h3>
            </div>
            <div className="space-y-2">
              {BANGLADESH_DIVISIONS.map(division => (
                <label key={division} className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={localFilters.divisions.includes(division)}
                    onChange={() => handleMultiSelectChange('divisions', division)}
                    className="rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500"
                  />
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-medium text-gray-900 dark:text-gray-100">Severity</h3>
            </div>
            <div className="space-y-2">
              {(['high', 'medium', 'low'] as SeverityLevel[]).map(level => (
                <label key={level} className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={localFilters.severityLevels.includes(level)}
                    onChange={() => handleMultiSelectChange('severityLevels', level)}
                    className="rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500"
                  />
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-medium text-gray-900 dark:text-gray-100">Verification</h3>
            </div>
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                ...
                className="rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500"
              />
              <span className="text-sm text-gray-700 dark:text-gray-300">Verified events only</span>
            </label>
          </div>
        </div>
